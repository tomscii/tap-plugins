/*                                                     -*- linux-c -*-
    ...
    $Id: tap_dynamics_st.c,v 1.1 2004/05/01 16:15:06 tszilagyi Exp $
*/
...
typedef struct {
	...
	LADSPA_Data gain_L;
	LADSPA_Data gain_R;
	LADSPA_Data gain_out_L;
	LADSPA_Data gain_out_R;
	rms_env * rms_L;
	rms_env * rms_R;
	LADSPA_Data sum_L;
	LADSPA_Data sum_R;
...
instantiate_Dynamics(const LADSPA_Descriptor * Descriptor, unsigned long sample_rate) {
	...
	LADSPA_Data amp_L = 0.0f;
	LADSPA_Data amp_R = 0.0f;
	LADSPA_Data env_L = 0.0f;
	LADSPA_Data env_R = 0.0f;
	LADSPA_Data gain_L = 0.0f;
	LADSPA_Data gain_R = 0.0f;
	LADSPA_Data gain_out_L = 0.0f;
	LADSPA_Data gain_out_R = 0.0f;
	rms_env * rms_L = NULL;
	rms_env * rms_R = NULL;
	LADSPA_Data sum_L = 0.0f;
	LADSPA_Data sum_R = 0.0f;
	int i;
...
run_Dynamics(LADSPA_Handle Instance,
	...
	LADSPA_Data * output_R = ptr->output_R;
        ...
        const LADSPA_Data offsgain = LIMIT(*(ptr->offsgain), -20.0f, 20.0f);
	...
	unsigned long sample_index;
        ...
        LADSPA_Data amp_L = ptr->amp_L;
        LADSPA_Data amp_R = ptr->amp_R;
        LADSPA_Data * as = ptr->as;
        unsigned int count = ptr->count;
        LADSPA_Data env_L = ptr->env_L;
        LADSPA_Data env_R = ptr->env_R;
        LADSPA_Data gain_L = ptr->gain_L;
        LADSPA_Data gain_R = ptr->gain_R;
        LADSPA_Data gain_out_L = ptr->gain_out_L;
        LADSPA_Data gain_out_R = ptr->gain_out_R;
        rms_env * rms_L = ptr->rms_L;
        rms_env * rms_R = ptr->rms_R;
        LADSPA_Data sum_L = ptr->sum_L;
        LADSPA_Data sum_R = ptr->sum_R;
	...
	LADSPA_Data level_L = 0.0f;
	LADSPA_Data level_R = 0.0f;
	LADSPA_Data adjust_L = 0.0f;
	LADSPA_Data adjust_R = 0.0f;
