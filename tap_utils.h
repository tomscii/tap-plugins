/*                                                     -*- linux-c -*-
    ...
    $Id: tap_utils.h,v 1.1 2004/01/31 20:54:15 tszilagyi Exp $
*/


/* Please note that the majority of the definitions and helper
functions in this file has been derived from the source code of Steve
...
static inline bq_t biquad_run(biquad *f, bq_t x) {
	bq_t y;
